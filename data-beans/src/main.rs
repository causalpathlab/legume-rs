...
We assume non-negative sparse matrices were generated by single-cell transcriptomics technology (feature x cell).
...
pub struct MergeMtxArgs {
    #[arg(
        ...
        long_help = "Within each directory and its sub-directories, the program will search for files named \
		     as specified by \
                     (1) `mtx_file_name`, \
		     (2) `feature_file_name`, \
...
pub struct RunStatArgs {
    ...
    #[arg(
        ...
        long_help = "Specify a pattern to select row names when accumulating statistics over columns. \
    ...
    #[arg(
        ...
        long_help = "Provide a file that defines column group membership when accumulating statistics over rows. \
...
pub struct RunSimulateArgs {
    ...
    #[arg(
        ...
        long_help = "Set the proportion of variance explained by topic membership on the θ parameter. \
