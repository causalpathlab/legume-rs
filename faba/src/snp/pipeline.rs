...
/// triplet set: [`ALT`](data_beans::aux::feature_rows::ALT) reads and
/// [`DEPTH`](data_beans::aux::feature_rows::DEPTH) reads per cell per locus.
///
        ...
        .try_for_each_init(
            ...
            |cache, entry| -> anyhow::Result<()> {
                ...
                for site in sites.iter() {
                    ...
                    let alt_row = data_beans::aux::feature_rows::feature_row(
                        &locus,
                        data_beans::aux::feature_rows::BAF,
                        data_beans::aux::feature_rows::ALT,
                        None,
                    );
                    let depth_row = data_beans::aux::feature_rows::feature_row(
                        &locus,
                        data_beans::aux::feature_rows::BAF,
                        data_beans::aux::feature_rows::DEPTH,
                        None,
                    );
