...
pinto svd temp7.h5 -c temp/cells.parquet --coord-column-names x_centroid,y_centroid -o temp7 --preload-data -t 10

pinto propensity --latent-data-file temp7.latent.parquet --coord-pair-file temp7.coord_pairs.parquet -k 8 -o temp7
```
...
ggplot(.dt.show[sample(.N)][value < .5],
       aes(x_centroid, y_centroid, colour=variable, size=1 - value)) +
